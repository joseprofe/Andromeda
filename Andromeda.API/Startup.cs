...
using Andromeda.BL.Implementations;
using Andromeda.DAL;
using Andromeda.DAL.Contracts;
using Andromeda.DAL.Implementations;
...
namespace Andromeda.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Andromeda.API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Andromeda.API v1"));
            }
